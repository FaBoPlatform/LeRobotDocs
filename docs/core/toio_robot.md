...
toio本体をLeRobotで制御するための最小サンプル(GPT-5 Proで生成)です。
...
- `lerobot-robot-toio/setup.py`
- `lerobot-robot-toio/lerobot_robot_toio/__init__.py`
- `lerobot-robot-toio/lerobot_robot_toio/config_toio.py`
- `lerobot-robot-toio/lerobot_robot_toio/toio.py`
